...
def index():
    if request.method == 'POST':
        ...
        API_KEY = "zdjtceMl7i_9it0_bSV4p_1xzLiZALY8DZKGVfNWmgDh"
        ...
        response_scoring = requests.post(
            'https://eu-gb.ml.cloud.ibm.com/ml/v4/deployments/5f722bae-6e06-4163-aa2c-7f6273b346ae/predictions?version=2022-11-18',
